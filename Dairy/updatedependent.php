...
$EEssn =  mysqli_real_escape_string($link, $_POST['EEssn']);
 
// Attempt insert query execution
$sql = "UPDATE DEPENDENT SET  Essn='$Essn', Dependent_name='$Dependent_name', Gender='$Gender', Bdate='$Bdate', Relationship='$Relationship', mob_no='$mob_no' WHERE ESSN='$EEssn'";
